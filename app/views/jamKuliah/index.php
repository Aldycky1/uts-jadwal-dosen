    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><?= $data['title'] ?></h3> <a href="<?= base_url; ?>/jamKuliah/tambah" class="btn float-right btn-xs btn btn-primary">Tambah Jam Kuliah</a>
        </div>
        <div class="card-body">

          <form action="<?= base_url; ?>/jamKuliah/cari" method="post">
            <div class="row mb-3">
              <div class="col-lg-6">
